...
import { expectInt, expectU32, U32_MAX } from "./domain.js";
...
export class HKDFRng implements RandomNumberGenerator {
  ...
  constructor(
    ...
    this._salt = salt;
    this._pageLength = expectInt(pageLength, 1, U32_MAX, "pageLength");
    this._pageIndex = 0;
  }
  ...
  randomData(length: number): Uint8Array {
    return this.nextBytes(expectU32(length, "length"));
  }
