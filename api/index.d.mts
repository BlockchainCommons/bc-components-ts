...
export declare class ARID implements ToCbor, ToUR {
    ...
    static random({ rng }?: RngOptions): ARID;
    /**
...
export declare type Codable = ToCbor & CborTagged;
...
export declare class ECPrivateKey implements ECKey, ToCbor, ToUR {
    ...
    static random({ rng }?: RngOptions): ECPrivateKey;
    /** A fresh private key and its public key. */
    static keypair({ rng }?: RngOptions): [ECPrivateKey, ECPublicKey];
    /**
...
export declare class Ed25519PrivateKey {
    ...
    /** A fresh random value; pass `rng` to make it deterministic. */
    static random({ rng }?: RngOptions): Ed25519PrivateKey;
    /**
...
export declare class EncapsulationPrivateKey implements ReferenceProvider, ToCbor, ToUR {
    ...
    /** A fresh random value; pass `rng` to make it deterministic. */
    static random({ rng }?: RngOptions): EncapsulationPrivateKey;
    /** A fresh ML-KEM private key at `level`; pass `rng` to make it deterministic. */
    static randomMlkem(level?: MLKEMLevel, { rng }?: RngOptions): EncapsulationPrivateKey;
    /** A fresh private key and its public key. */
    static keypair({ rng }?: RngOptions): [EncapsulationPrivateKey, EncapsulationPublicKey];
    /** A fresh ML-KEM private key at `level` and its public key. */
    static mlkemKeypair(level?: MLKEMLevel, { rng }?: RngOptions): [EncapsulationPrivateKey, EncapsulationPublicKey];
    /**
     * Returns the encapsulation scheme.
     */
    get encapsulationScheme(): EncapsulationScheme;
...
export declare class PrivateKeyBase implements ToCbor, ToUR, Decrypter {
    ...
    private constructor();
    /** A fresh random value; pass `rng` to make it deterministic. */
    static random({ rng }?: RngOptions): PrivateKeyBase;
    /**
...
export declare class PrivateKeys implements Signer, Decrypter, ReferenceProvider, ToCbor, ToUR {
    ...
    static random({ rng }?: RngOptions): PrivateKeys;
    /**
...
export declare class SealedMessage implements ToCbor, ToUR {
     ...
     */
    static seal(plaintext: Uint8Array, recipient: EncapsulationPublicKey, { aad, nonce, rng }?: {
        aad?: Uint8Array;
        nonce?: Nonce;
...
export declare interface Signer {
     ...
     * - SSH: Requires namespace and hash algorithm
...
export declare class UUID implements ToCbor, ToUR {
     ...
     */
    static random({ rng }?: RngOptions): UUID;
    /** The bytes (a view; do not mutate). */
    /** A copy of the bytes; mutating it does not touch this value. */
    get bytes(): Uint8Array;
    /**
...
export declare class X25519PrivateKey implements ToCbor, ToUR {
    ...
    private constructor();
    /** A fresh random value; pass `rng` to make it deterministic. */
    static random({ rng }?: RngOptions): X25519PrivateKey;
    /** A fresh private key and its public key. */
    static keypair({ rng }?: RngOptions): [X25519PrivateKey, X25519PublicKey];
    /**
...
export declare class XID implements ToCbor, ToUR, XIDProvider, ReferenceProvider {
     ...
     */
    static random({ rng }?: RngOptions): XID;
    /**
