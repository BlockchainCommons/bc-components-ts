...
describe("HKDFParams", () => {
  describe("creation", () => {
    ...
    it("should create with custom settings", () => {
      ...
      const params = HKDFParams.from({ salt: salt, hashType: HashType.SHA512 });
  ...
  describe("equality", () => {
    it("should be equal with same salt and hash type", () => {
      const salt = Salt.random({ length: 16 });
      const params1 = HKDFParams.from({ salt: salt, hashType: HashType.SHA256 });
      const params2 = HKDFParams.from({ salt: salt, hashType: HashType.SHA256 });
    ...
    it("should not be equal with different hash type", () => {
      const salt = Salt.random({ length: 16 });
      const params1 = HKDFParams.from({ salt: salt, hashType: HashType.SHA256 });
      const params2 = HKDFParams.from({ salt: salt, hashType: HashType.SHA512 });
...
describe("ScryptParams", () => {
  describe("creation", () => {
    it("should create with defaults", () => {
      const params = ScryptParams.from();
      expect(params.salt).toBeDefined();
    ...
    it("should create with custom settings", () => {
      const salt = Salt.random({ length: 16 });
      const params = ScryptParams.from({ salt: salt, logN: 14, r: 16, p: 2 });
      expect(params.salt.equals(salt)).toBe(true);
...
describe("Argon2idParams", () => {
  describe("creation", () => {
    it("should create with defaults", () => {
      const params = Argon2idParams.from();
      expect(params.salt).toBeDefined();
...
describe("SSHAgentParams", () => {
  describe("creation", () => {
    it("should create with default salt and ID", () => {
      const params = SSHAgentParams.from({ id: "test-key-id" });
      expect(params.salt).toBeDefined();
    ...
    it("should create with custom salt and ID", () => {
      const salt = Salt.random({ length: 16 });
      const params = SSHAgentParams.from({ salt: salt, id: "custom-key" });
      expect(params.salt.equals(salt)).toBe(true);
  ...
  describe("equality", () => {
    it("should be equal with same salt and id", () => {
      const salt = Salt.random({ length: 16 });
      const params1 = SSHAgentParams.from({ salt: salt, id: "key-id" });
      const params2 = SSHAgentParams.from({ salt: salt, id: "key-id" });
      expect(params1.equals(params2)).toBe(true);
    });

    it("should not be equal with different id", () => {
      const salt = Salt.random({ length: 16 });
      const params1 = SSHAgentParams.from({ salt: salt, id: "key-id-1" });
      const params2 = SSHAgentParams.from({ salt: salt, id: "key-id-2" });
      expect(params1.equals(params2)).toBe(false);
    });
  });
...
describe("KeyDerivationParams", () => {
  describe("factory functions", () => {
    ...
    it("should create SSH agent params from instance", () => {
      const sshParams = SSHAgentParams.from({ id: "my-key" });
...
describe("EncryptedKey", () => {
  ...
  describe("PBKDF2 roundtrip", () => {
    it("should encrypt and decrypt with PBKDF2", () => {
      ...
      const salt = Salt.random({ length: 16 });
      const pbkdf2 = PBKDF2Params.from({ salt: salt, iterations: 1000, hashType: HashType.SHA256 });
  ...
  describe("Scrypt roundtrip", () => {
    it("should encrypt and decrypt with Scrypt", () => {
      ...
      const salt = Salt.random({ length: 16 });
      const scrypt = ScryptParams.from({ salt: salt, logN: 10, r: 8, p: 1 });
  ...
  describe("params variant", () => {
    it("should have correct params type for each method", { timeout: 30000 }, () => {
      ...
      const salt = Salt.random({ length: 16 });
      const pbkdf2P = PBKDF2Params.from({
        salt: salt,
        iterations: 1000,
      ...
      const scryptP = ScryptParams.from({ salt: salt, logN: 10, r: 8, p: 1 });
