...
`@blockchaincommons/components` depends on `@blockchaincommons/crypto`, `@blockchaincommons/dcbor-compat`, `@blockchaincommons/rand`, `@blockchaincommons/sskr`, `@blockchaincommons/tags`, `@blockchaincommons/uniform-resources`, `@noble/curves`, `@noble/hashes`, `@noble/post-quantum`, `@scure/base`, `@scure/sr25519`, `pako` at runtime.
...
- [BlockchainCommons/bc-components-rust](https://github.com/BlockchainCommons/bc-components-rust) - The reference Rust implementation, by [Wolf McNally](https://github.com/wolfmcnally).
